...
from news_scrapping import sentiment_score, sentiment_scoring, sentiment_scoring_long
import sys
import pytz
...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 3 and sys.argv[1] == '-ti':
        ...
        for portals in datastore['news_portal']:
            ...
            for link in links:
                ...
                if scrap == True:
                    ...
                    scrapped_news = {"keyword": sys.argv[2], "instance": instance, "source": portal_name, "scraping_date": scraping_date, "link": link, "title": result['title'], "news_date": result['news_date'], "content": re.sub(r'.* -\s', '', result['content'].decode('utf-8')), "error": result['error'].decode('utf-8')}
