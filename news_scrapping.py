...
def getContent2(link, content_tag, content_class, paragraph_tag, paragraph_class, news_date_tag, news_date_class, datetime_regex, date_format):
    try:
        ...
        for paragraph in paragraphs:
            ...
            if paragraph.get_text().find('Baca Juga:') == -1 and paragraph.get_text().find('Baca juga:') == -1 and paragraph.get_text().find('Pilihan Editor:') == -1 and paragraph.get_text().find('Lihat juga:') == -1 and paragraph.get_text().find('Lihat Juga:') == -1:
